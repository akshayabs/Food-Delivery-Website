        ...
        <Row>
            ...
            <h6 className='mb-4'>Shipping Address</h6>
             <form className='checkout__form' onSubmit={submitHandler}>
               ...
               <div className='form__group'>
                 ...
                 required onChange={e=> setPostalAddress(e.target.value)}/>
               </div>
               <div className='form__group'>
                 <input type="number" placeholder='Pincode'
                 required onChange={e=> setPinCode(e.target.value)}/>
               </div>
               <Link to="/payment"><button className="addTOCart__btn">
                    Proceed to Pay
                  </button></Link>
             </form>
          ...
          <Col lg='4' md='6'>
           <div className='checkout__bill'>
               ...
               justify-content-between mb-3'>Subtotal: <span>₹{cartTotalAmount}</span></h6>
               <h6 className='d-flex align-items-center
               justify-content-between '>Shipping: <span>₹{shippingCost}</span></h6>
               <div className='checkout__total'>
                  <h5 className='d-flex align-items-center
                  justify-content-between '>Total: <span>₹{totalAmount}</span></h5>
               </div>
            </div>
          </Col>
